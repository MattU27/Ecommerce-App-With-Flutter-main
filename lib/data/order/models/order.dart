...
class OrderModel {
  ...
  factory OrderModel.fromMap(Map<String, dynamic> map) {
    return OrderModel(
      ...
      createdDate: map['createdDate'] as String? ?? '', // Default to empty string if null
      shippingAddress: map['shippingAddress'] as String? ?? '', // Default to empty string if null
      itemCount: map['itemCount'] as int? ?? 0, // Default to 0 if null
      totalPrice: map['totalPrice'] as double? ?? 0.0, // Default to 0.0 if null
      code: map['code'] as String? ?? '', // Default to empty string if null
